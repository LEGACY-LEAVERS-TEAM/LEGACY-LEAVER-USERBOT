...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/LEGACY-LEAVERS-TEAM/LEGACY-LEAVER-USERBOT.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/3e5a4478f5e213c1d1dea.jpg"
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, "**⚡Legacy-Userbot⚡** ```Has Been Active!```")
    return
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Userbot Legacy Leavers Is Up Running!**\n\n"
